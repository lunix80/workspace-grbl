...
| chilipeppr.load() URL | http://raw.githubusercontent.com/lunix80/workspace-grbl/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/lunix80/grbl-v1 |
| Github URL            | http://github.com/lunix80/workspace-grbl |
| Test URL              | https://preview.c9users.io/lunix80/grbl-v1/workspace.html |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/lunix80/workspace-grbl/master/auto-generated-workspace.html",
  function() {
    ...
    cprequire(
      ...
      function(myWorkspaceGrblV1) {
        ...
        console.log("Workspace / grbl just got loaded.", myWorkspaceGrblV1);
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-grbl-v1"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / grbl"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"A ChiliPeppr Workspace grbl."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/lunix80/workspace-grbl/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/lunix80/grbl-v1"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/lunix80/workspace-grbl"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://grbl-v1-lunix80.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
