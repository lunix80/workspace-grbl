        ...
        loadWidgets: function(callback) {
                    ...
                    cprequire(
                        ...
                        function(spc) {
                            ...
                            var newOnRecvLine = function(data) {
                                ...
                                var confMsg = /^\$([0-9]+)=(.*)/g;
                                var confStr = confMsg.exec(data.dataline);
                                  
                                if (confStr){
                                    // adding some info to config messages 
            ...
            chilipeppr.load(
              ...
              // "http://raw.githubusercontent.com/lunix80/grbl1-test-widget/master/auto-generated-widget.html",
               "https://raw.githubusercontent.com/jpadie/grbl1-test-widget/master/auto-generated-widget.html", // jpadie version
               // "http://jsfiddle.net/lunix80/L4nvo7r7/show/light/", //  my version
              //  "https://raw.githubusercontent.com/lunix80/grbl1-test-widget/master/auto-generated-widget.html", // my version on github
              function() {
            ...
            chilipeppr.load(
                ...
                function(){
                cprequire(["inline:com-chilipepper-grbl-joystick"],
                    function(joy){
